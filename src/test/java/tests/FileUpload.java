...
public class FileUpload {
    ...
    public void fileUpload() throws AWTException, InterruptedException {
        driver.findElement(By.id("Email")).sendKeys("rathnatesting");
        driver.findElement(By.id("next")).click();
        driver.findElement(By.id("Passwd")).sendKeys("rainhouse9#"); // Enter your password
        //EnterPassword.enterPassword(driver); // Delete this line
        driver.findElement(By.id("signIn")).click();
        driver.findElement(By.xpath("//div[text()='COMPOSE']")).click();
        driver.findElement(By.xpath("//div[@class='wO nr l1']//textarea")).sendKeys("rathnatesting@gmail.com");
